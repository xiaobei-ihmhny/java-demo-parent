...
public interface BlockingQueue<E> extends Queue<E> {
    ...
    /**
     * 将指定的元素插入此队列，如果队列已满，会一直阻塞，直到队列可用。
     *
    ...
    /**
     * 基于阻塞的方式获取队列中的元素，如果队列为空，
     * 则该方法会一直阻塞，直到队列中有新的数据可以消费
     *
     ...
     *
     *
     * 请注意，您无法始终通过检查剩余容量来判断插入元素的尝试是否会成功，
     * 因为可能是另一线程即将插入或删除元素的情况。
     *
     ...
     * 更正式地说，如果此队列包含一个或多个这样的元素，则删除元素e需要满足 o.equals（e）。
