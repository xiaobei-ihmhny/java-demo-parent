...
public class ForkJoinPool extends AbstractExecutorService {
    ...
    static final int MAX_CAP      = 0x7fff;        // max #workers - 1          0000 0000 0000 0000 0111 1111 1111 1111
    ...
    static final int SCANNING     = 1;             // false when running tasks  0000 0000 0000 0000 0000 0000 0000 0001
    static final int INACTIVE     = 1 << 31;       // must be negative          1000 0000 0000 0000 0000 0000 0000 0000
    static final int SS_SEQ       = 1 << 16;       // version count             0000 0000 0000 0001 0000 0000 0000 0000

    // Mode bits for ForkJoinPool.config and WorkQueue.config
    static final int MODE_MASK    = 0xffff << 16;  // top half of int           1111 1111 1111 1111 0000 0000 0000 0000
    static final int LIFO_QUEUE   = 0;
    static final int FIFO_QUEUE   = 1 << 16;//                                  0000 0000 0000 0001 0000 0000 0000 0000
    static final int SHARED_QUEUE = 1 << 31;       // must be negative          1000 0000 0000 0000 0000 0000 0000 0000
    ...
    static final class WorkQueue {
        ...
        final void push(ForkJoinTask<?> task) {
            ...
            if ((a = array) != null) {    // ignore if queue removed
                ...
                // 如果当前 WorkQueue 为新建的等待队列（top - base <= 1），
        ...
        */
         ...
         * to exec until empty.
         *
         * 构建线程池时的asyncMode参数，决定了工作线程执行自身队列中的任务的方式。
         * 如果 asyncMode == true，则以FIFO的方式执行任务；否则，以LIFO的方式执行任务。
         *
         */
    ...
    final void runWorker(WorkQueue w) {
        ...
        for (ForkJoinTask<?> t;;) {
            ...
            // 如果awaitWork返回false，等不到任务，则跳出runWorker的循环，
            // 回到run中执行finally，最后调用deregisterWorker注销工作线程。
            ...
            for (int origin = r & m, k = origin, oldSum = 0, checkSum = 0;;) {
                ...
                if ((q = ws[k]) != null) {// 获取workQueue
                    if ((n = (b = q.base) - q.top) < 0 &&
                        ...
                        if ((t = ((ForkJoinTask<?>) U.getObjectVolatile(a, i))) != null && q.base == b) {// 取base位置任务
                            // 成功获取到任务
                            if (ss >= 0) {
     ...
     *
     * tryCompensate主要用来补偿工作线程因为阻塞而导致的算力损失，
     * 当工作线程自身的队列不为空，且还有其它空闲工作线程时，
     * 如果自己阻塞了，则在此之前会唤醒一个工作线程。
     *
     * @param w caller
     */
    ...
    private void externalSubmit(ForkJoinTask<?> task) {
        ...
        for (;;) {
            ...
            // CASE4: 创建一个任务队列
                ...
                q.hint = r;
                // k为任务队列在队列数组中的索引: k == r & m & SQMASK, 在CASE3的IF判断中赋值
     ...
     * for externalSubmit.
     *
     * TODO 需详细分析过程 2020年12月24日18:2:6
     *
     * @param task the task. Caller must ensure non-null.
     */
     ...
     *                    ForkJoinPool里工作线程数量与该参数有关，但它不表示最大线程数；
     * @param factory 工作线程工厂，，默认是DefaultForkJoinWorkerThreadFactory，
     *                其实就是用来创建工作线程对象——ForkJoinWorkerThread；
     * @param handler 异常处理器
