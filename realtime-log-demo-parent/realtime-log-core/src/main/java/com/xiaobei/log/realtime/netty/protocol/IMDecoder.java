package com.xiaobei.log.realtime.netty.protocol;
...
public class IMDecoder extends ByteToMessageDecoder {
	...
	//解析IM写一下请求内容的正则
	private Pattern pattern = Pattern.compile("^\\[(.*)\\](\\s\\-\\s(.*))?",Pattern.CASE_INSENSITIVE | Pattern.DOTALL);
	...
	public static void main(String[] args) {
		String msg = "[CHAT][1618749814901][xiaobei] - \r2131321\r\n544564sdfsd\r";
